...
class InstructionSubstract(Instruction):
    ...
    def parse(string):
        ...
        if string_no_spaces[0:4].lower() != "sub ":
            return None
        ...
        return InstructionSubstract(arg1, arg2, cell)
    ...
    def __eq__(self, other):
        if not isinstance(other, InstructionSubstract):
            return False
        return other.arg1 == self.arg1 and other.arg2 == self.arg2 and other.cell == self.cell

    def __repr__(self):
        return "SUB " + str(self.arg1) + " " + str(self.arg2) + " " + str(self.cell)
