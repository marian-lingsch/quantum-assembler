...
class InstructionModulo(Instruction):
    ...
    def parse(string):
        ...
        if string_no_spaces[0:4].lower() != "mod ":
            return None
        ...
        return InstructionModulo(arg1, arg2, cell)
    ...
    def __eq__(self, other):
        if not isinstance(other, InstructionModulo):
            return False
        return other.arg1 == self.arg1 and other.arg2 == self.arg2 and other.cell == self.cell

    def __repr__(self):
        return "MOD " + str(self.arg1) + " " + str(self.arg2) + " " + str(self.cell)
