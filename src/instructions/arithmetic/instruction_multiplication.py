...
class InstructionMultiplication(Instruction):
    ...
    def parse(string):
        ...
        if string_no_spaces[0:4].lower() != "mul ":
            return None
        ...
        return InstructionMultiplication(arg1, arg2, cell)
    ...
    def update_db_sql_statement(self, tablename, binary_program_counter, int_program_counter, binary_instruction,
        ...
        int_value_cell_3 = "( " + int_value_cell1 + ") * (" + int_value_cell2 + ")"
    ...
    def __eq__(self, other):
        if not isinstance(other, InstructionMultiplication):
            return False
        return other.arg1 == self.arg1 and other.arg2 == self.arg2 and other.cell == self.cell

    def __repr__(self):
        return "MUL " + str(self.arg1) + " " + str(self.arg2) + " " + str(self.cell)
